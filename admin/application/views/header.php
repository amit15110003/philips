...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url("index.php/admin"); ?>" class="logo">
      ...
      <span class="logo-mini"><b>Arkish</b>Jewels</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Arkish</b>Jewels</span>
    </a>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo base_url('index.php/admin/purity'); ?>"><i class="fa fa-circle-o"></i> Purity</a></li>
            <li><a href="<?php echo base_url('index.php/admin/type'); ?>"><i class="fa fa-circle-o"></i>Add Color</a></li>
          </ul>
        </li>
        <li>
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-table"></i> <span>UI Update</span>
            <i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url('index.php/admin/slider'); ?>"><i class="fa fa-circle-o"></i>Slider</a></li>
