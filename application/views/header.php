    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 text-center">
          <a href="index.html" class="main-logo"><img src="<?php echo base_url(); ?>media/images/main-logo.png" alt="" class="img-responsive" style="height: 100px;"></a>
          <a href="index.html" class="small-logo"><img src="<?php echo base_url(); ?>media/images/main-logo.png" alt="" class="img-responsive" style="height:60px;"></a>
